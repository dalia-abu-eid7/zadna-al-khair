...
<style>
    ...
    /* أزرار اختيار نوع الحساب (مطعم / جمعية) */
    .account-selection {
        display: flex;
        gap: 15px;
        margin-bottom: 25px;
    ...
    /* تمييز الجمعية لأننا في صفحة تسجيل الجمعية */
    .selection-card.active-charity {
        border-color: #27ae60;
    ...
    .submit-next-btn:hover { background-color: #27ae60; }
...
<div class="auth-container-unified">
    ...
    <div class="form-side">
        ...
        <div class="account-selection">
            <a href="{{ route('charity.register') }}" class="selection-card active-charity">
                <span style="font-size: 1.2rem;">♡</span>
                <span>جمعية خيرية</span>
            </a>
            <a href="{{ route('restaurant.register') }}" class="selection-card">
                <span style="font-size: 1.2rem;">🍴</span>
                <span>مطعم</span>
            </a>
        </div>
    ...
    @if ($errors->any())
        <div style="color: #e74c3c; background: #fdf2f2; padding: 15px; border-radius: 8px; margin-bottom: 20px; border: 1px solid #fab1a0;">
            <strong>يوجد أخطاء في البيانات:</strong>
            <ul style="margin-top: 5px; list-style: disc; padding-right: 20px;">
    ...
    <div class="form-row-unified">
        <div class="input-group-unified">
            ...
            <input type="text" name="EntityName" value="{{ old('EntityName') }}" placeholder="مثال: جمعية الإحسان">
        </div>
        <div class="input-group-unified">
            <label>جهة الاتصال</label>
            <input type="text" name="ContactPerson" value="{{ old('ContactPerson') }}" placeholder="اسم الشخص المسؤول">
        </div>
    </div>
    ...
    <div class="form-row-unified">
        <div class="input-group-unified">
            <label>العنوان</label>
            <input type="text" name="Address" value="{{ old('Address') }}" placeholder="العنوان التفصيلي">
        </div>
        <div class="input-group-unified">
            <label>رقم الترخيص</label>
            <input type="text" name="LicenseNumber" value="{{ old('LicenseNumber') }}" placeholder="رقم السجل">
        </div>
    </div>
