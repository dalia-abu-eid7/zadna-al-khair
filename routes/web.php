...
Route::prefix('register/charity')->group(function () {
    ...
    Route::post('/step2', [CharityRegisterController::class, 'showRegistrationStep2'])->name('charity.register.step2');
    Route::post('/store', [CharityRegisterController::class, 'registerCharity'])->name('charity.register.post');
});
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('admin')->name('admin.')->group(function() {
        ...
        Route::post('/entities/toggle/{id}', [AdminDashboardController::class, 'toggleStatus'])->name('entities.toggle');
...
Route::prefix('restaurant')->name('restaurant.')->middleware('auth')->group(function() {
    ...
    // تأكدي من وجود هذين السطرين بالأسماء الصحيحة
...
// مسارات الجمعية
// مسارات الجمعية
Route::prefix('association')->name('association.')->middleware('auth')->group(function() {
